# -*- coding: utf-8 -*-
"""
Created on Fri Nov  9 13:53:56 2018
...
def load_dataset(dirpath="C:/Users/Akumarx084109/Desktop/Abhineet/DATA_SCIENCE/ACADGILD/Project/ACADGILD-PROJECT-6/cifar-10-batches-py"):# give path as per data file directory structure for ex: "/home/username/folder name"
    X, y = [], []
...
def main_function(num_epochs=100):
    ...
    if not os.path.exists('C:/Users/Akumarx084109/Desktop/Abhineet/DATA_SCIENCE/ACADGILD/Project/ACADGILD-PROJECT-6/Image_classification-model.ckpt.meta'): 
        ...
        save_path = saver.save(sess,"C:/Users/Akumarx084109/Desktop/Abhineet/DATA_SCIENCE/ACADGILD/Project/ACADGILD-PROJECT-6/Image_classification-model.ckpt")
        ...
        saver = tf.train.import_meta_graph('C:/Users/Akumarx084109/Desktop/Abhineet/DATA_SCIENCE/ACADGILD/Project/ACADGILD-PROJECT-6/Image_classification-model.ckpt.meta')
        saver.restore(sess,'C:/Users/Akumarx084109/Desktop/Abhineet/DATA_SCIENCE/ACADGILD/Project/ACADGILD-PROJECT-6/Image_classification-model.ckpt.data-00000-of-00001')
    
    # testing random image from the anywhere
    img = cv2.imread('C:/Users/Akumarx084109/Desktop/Abhineet/DATA_SCIENCE/ACADGILD/Project/ACADGILD-PROJECT-6/Aeroplane.jpg')
